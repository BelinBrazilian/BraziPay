...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
    ...
    <x-menu.user-account.separator />
    <x-menu.user-account.menu-item title="My Profile" link="#" />
    ...
    <x-menu.user-account.menu-item title="My Projects" link="#" :data-link-attributes="['badge' => ['text' => '3']]" />
    ...
    <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
        ...
        <div class="menu-sub menu-sub-dropdown w-175px py-4">
            ...
            <x-menu.user-account.menu-item title="Referrals" link="#" />
            <x-menu.user-account.menu-item title="Billing" link="#" />
            <x-menu.user-account.menu-item title="Payments" link="#" />
    ...
    <x-menu.user-account.menu-item title="My Statements" link="#" />
    <x-menu.user-account.separator />
    ...
    <x-menu.user-account.menu-item title="Account Settings" link="#" />
