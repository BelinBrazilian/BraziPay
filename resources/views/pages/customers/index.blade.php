        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Search customer" id="mySearchInput"/>
                </div>
                {{-- end::Search --}}
            </div>
            {{-- end::Card title --}}
    ...
    @push('scripts')
        ...
        <script>
            ...
            $('#kt_modal_add_customer').on('hidden.bs.modal', function () {
                Livewire.dispatch('new_customer');
            });
        </script>
    @endpush
